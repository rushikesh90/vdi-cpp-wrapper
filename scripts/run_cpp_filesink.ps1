...
# Define paths
$WrapperPath = ".\vdi_wrapper_file.exe"
...
Write-Host "Starting C++ File Sink VDI Backup with Benchmark ID: $BenchmarkId" -ForegroundColor Green
...
$metricsFileName = "cpp_filesink_$BenchmarkId`_$timestamp.json"
